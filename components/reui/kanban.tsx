...
function KanbanColumn({
    ...
    const defaultProps = {
        ...
        "data-disabled": isOverlay ? false : disabled,
        ref: isOverlay ? undefined : setNodeRef,
        style,
        className: cn(
            "group/kanban-column flex flex-col",
            isOverlay ? "" : (isSortableDragging && "opacity-50 z-50"),
            !isOverlay && disabled && "opacity-50",
            className
        ),
        children: props.children,
    }
    ...
    const columnContextValue = React.useMemo(() => {
        ...
        return { attributes, listeners, isDragging: isColumnDragging, disabled }
...
function KanbanItem({
    ...
    const itemContextValue = React.useMemo(() => {
        if (isOverlay) {
            return { listeners: undefined, isDragging: true, disabled: false }
        }
        return { listeners, isDragging: isItemDragging, disabled }
